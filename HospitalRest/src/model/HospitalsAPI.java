...
public class HospitalsAPI extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		String output = hospitalObj.insertHospital(request.getParameter("hospitalCode"), request.getParameter("hospitalName"),
				request.getParameter("hospitalAdress"), request.getParameter("hospitalPhoneNo"));
	...
	protected void doPut(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String output = hospitalObj.updateHospital(paras.get("hidHospitalIDSave").toString(),
				...
				paras.get("hospitalAdress").toString(),
